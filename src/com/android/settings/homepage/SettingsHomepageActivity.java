...
public class SettingsHomepageActivity extends FragmentActivity implements
    ...
    static final int DEFAULT_HIGHLIGHT_MENU_KEY = R.string.menu_key_sigma_toolbox;
    ...
    private void initAvatarView() {
        ...
        ImageView avatarTwoPaneView = findViewById(R.id.account_avatar_two_pane_version);
        if (AvatarViewMixin.isAvatarSupported(this)) {
            ...
            if (mIsEmbeddingActivityEnabled && avatarTwoPaneView != null) {
                avatarTwoPaneView.setImageDrawable(getCircularUserIcon(getApplicationContext()));
                avatarTwoPaneView.setVisibility(View.VISIBLE);
                avatarTwoPaneView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Intent.ACTION_MAIN);
                        intent.setComponent(new ComponentName("com.android.settings","com.android.settings.Settings$UserSettingsActivity"));
