...
public class TopMenu extends Preference {
    ...
    public TopMenu(Context context, AttributeSet attrs) {
        ...
        setLayoutResource(context.getResources().
                getIdentifier(gridStyle ? "layout/nad_top_menu_grid" : "layout/nad_top_menu", null, context.getPackageName()));
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        **/
        ...
        LinearLayout mNadTop = holder.itemView.findViewById(context.getResources().
                getIdentifier("id/nad", null, context.getPackageName()));
